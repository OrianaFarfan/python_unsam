# -*- coding: utf-8 -*-
"""
Created on Tue Nov  2 23:24:20 2021
...
def generar_listas(N):
    Lista=[]
    for i in range(1,N):
        lista = np.random.randint (1,1000,i) #Genero array de i elementos
        Lista.append(lista)
    return Lista
...
def experimento_timeit_seleccion(listas, num):
    ...
    for lista in listas:
        ...
        # evalúo el método de selección en una copia nueva para cada iteración
